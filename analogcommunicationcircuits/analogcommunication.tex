...
\textcolor{red}{TODO:Add circuit diagram}
\section*{Procedure}
\begin{itemize}
\item
...
\item
Plot frequency response characteristics. Find out resonant frequency, bandwidth and Q-factor.
\end{itemize}
\section*{Observation}
\textcolor{red}{TODO:frequency response curve of gain to be added, tabular column to be added}. 
\section*{Result}
