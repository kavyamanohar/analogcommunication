...
\label{IFT}
IFT acts as parallel resonant circuits whose resonating frequency is around 455 kHz. This frequecy is adjustable by a factor of $\pm 10 \%$ . IFT has a tapped primary winding and a secondary winding. Primary winding has a capacitor connected in parallel internally. Its inductor value is $L_eq=450\mu H$ and capacitance $C=270\ pF$. 
...
\includegraphics[width=10cm, height=8cm]{IFT.png}
